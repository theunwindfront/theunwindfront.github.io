...
Window::open()
    ...
    ->width(800)
    ->height(600);
`,language:"php",theme:"vs-dark",automaticLayout:!0,fontSize:14,minimap:{enabled:!1},fontFamily:"'Fira Code', 'Monaco', monospace",padding:{top:20},scrollBeyondLastLine:!1,smoothScrolling:!0,cursorBlinking:"expand"}),console.log("Monaco Engine Loaded."))});const r=document.querySelector(".mock-canvas");l();function l(){r.innerHTML=`
